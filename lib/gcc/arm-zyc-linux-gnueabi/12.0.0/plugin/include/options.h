...
enum opt_code
{
  ...
  OPT_mbionic = 1727,                        /* -mbionic */
  OPT_mbranch_cost_ = 1728,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1729,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1730,     /* -mcaller-super-interworking */
  OPT_mcmse = 1731,                          /* -mcmse */
  OPT_mcpu_ = 1732,                          /* -mcpu= */
  OPT_mfdpic = 1733,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1734,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1735,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1736,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1737,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1738,                  /* -mfp16-format= */
  OPT_mfpu_ = 1739,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1740,             /* -mgeneral-regs-only */
  OPT_mglibc = 1741,                         /* -mglibc */
  /* OPT_mhard_float = 1742, */              /* -mhard-float */
  OPT_mlibarch_ = 1743,                      /* -mlibarch= */
  OPT_mlittle_endian = 1744,                 /* -mlittle-endian */
  OPT_mlong_calls = 1745,                    /* -mlong-calls */
  OPT_mmusl = 1746,                          /* -mmusl */
  OPT_mneon_for_64bits = 1747,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1748,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1749,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1750,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1751,               /* -mprint-tune-info */
  OPT_mpure_code = 1752,                     /* -mpure-code */
  OPT_mrestrict_it = 1753,                   /* -mrestrict-it */
  OPT_msched_prolog = 1754,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1755,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1756,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1757, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1758,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1759,                         /* -mthumb */
  OPT_mthumb_interwork = 1760,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1761,                  /* -mtls-dialect= */
  OPT_mtp_ = 1762,                           /* -mtp= */
  OPT_mtpcs_frame = 1763,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1764,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1765,                         /* -mtune= */
  OPT_muclibc = 1766,                        /* -muclibc */
  OPT_munaligned_access = 1767,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1768,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1769,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1770,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1771,              /* -mword-relocations */
  OPT_n = 1772,                              /* -n */
  OPT_name_sort = 1773,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1774,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1775,              /* -no-integrated-cpp */
  OPT_no_pie = 1776,                         /* -no-pie */
  OPT_nocpp = 1777,                          /* -nocpp */
  OPT_nodefaultlibs = 1778,                  /* -nodefaultlibs */
  OPT_nolibc = 1779,                         /* -nolibc */
  OPT_nophoboslib = 1780,                    /* -nophoboslib */
  OPT_nostartfiles = 1781,                   /* -nostartfiles */
  OPT_nostdinc = 1782,                       /* -nostdinc */
  OPT_nostdinc__ = 1783,                     /* -nostdinc++ */
  OPT_nostdlib = 1784,                       /* -nostdlib */
  OPT_o = 1785,                              /* -o */
  OPT_objects = 1786,                        /* -objects */
  OPT_p = 1787,                              /* -p */
  OPT_pass_exit_codes = 1788,                /* -pass-exit-codes */
  /* OPT_pedantic = 1789, */                 /* -pedantic */
  OPT_pedantic_errors = 1790,                /* -pedantic-errors */
  OPT_pg = 1791,                             /* -pg */
  OPT_pie = 1792,                            /* -pie */
  OPT_pipe = 1793,                           /* -pipe */
  OPT_posix = 1794,                          /* -posix */
  OPT_print_file_name_ = 1795,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1796,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1797,          /* -print-multi-directory */
  OPT_print_multi_lib = 1798,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1799,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1800,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1801,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1802,               /* -print-prog-name= */
  OPT_print_search_dirs = 1803,              /* -print-search-dirs */
  OPT_print_sysroot = 1804,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1805,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1806,                    /* -print-value */
  OPT_profile = 1807,                        /* -profile */
  OPT_pthread = 1808,                        /* -pthread */
  OPT_quiet = 1809,                          /* -quiet */
  OPT_r = 1810,                              /* -r */
  OPT_rdynamic = 1811,                       /* -rdynamic */
  OPT_remap = 1812,                          /* -remap */
  OPT_reverse_sort = 1813,                   /* -reverse-sort */
  OPT_s = 1814,                              /* -s */
  OPT_save_temps = 1815,                     /* -save-temps */
  OPT_save_temps_ = 1816,                    /* -save-temps= */
  OPT_shared = 1817,                         /* -shared */
  OPT_shared_libgcc = 1818,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1819,               /* -shared-libphobos */
  OPT_size_sort = 1820,                      /* -size-sort */
  /* OPT_specs = 1821, */                    /* -specs */
  OPT_specs_ = 1822,                         /* -specs= */
  OPT_static = 1823,                         /* -static */
  OPT_static_libasan = 1824,                 /* -static-libasan */
  OPT_static_libgcc = 1825,                  /* -static-libgcc */
  OPT_static_libgfortran = 1826,             /* -static-libgfortran */
  OPT_static_libgo = 1827,                   /* -static-libgo */
  OPT_static_libhwasan = 1828,               /* -static-libhwasan */
  OPT_static_liblsan = 1829,                 /* -static-liblsan */
  OPT_static_libmpx = 1830,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1831,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1832,               /* -static-libphobos */
  OPT_static_libstdc__ = 1833,               /* -static-libstdc++ */
  OPT_static_libtsan = 1834,                 /* -static-libtsan */
  OPT_static_libubsan = 1835,                /* -static-libubsan */
  OPT_static_pie = 1836,                     /* -static-pie */
  /* OPT_std_c__03 = 1837, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1838, */                /* -std=c++0x */
  OPT_std_c__11 = 1839,                      /* -std=c++11 */
  OPT_std_c__14 = 1840,                      /* -std=c++14 */
  OPT_std_c__17 = 1841,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1842, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1843, */                /* -std=c++1z */
  OPT_std_c__20 = 1844,                      /* -std=c++20 */
  OPT_std_c__23 = 1845,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1846, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1847, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1872,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1873, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1874, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1875,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1876,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1877,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1878, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1879, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1880,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1881, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1882,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1883,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1884, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1885, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1886,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1887, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1888, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1889, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1890, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1891, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1892,                     /* -std=legacy */
  OPT_stdlib_ = 1893,                        /* -stdlib= */
  OPT_symbol_ = 1894,                        /* -symbol= */
  OPT_symbolic = 1895,                       /* -symbolic */
  OPT_t = 1896,                              /* -t */
  OPT_time = 1897,                           /* -time */
  OPT_time_ = 1898,                          /* -time= */
  OPT_tno_android_cc = 1899,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1900,                 /* -tno-android-ld */
