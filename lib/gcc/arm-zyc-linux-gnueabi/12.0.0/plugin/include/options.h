...
enum opt_code
{
  ...
  OPT_muclibc = 1801,                        /* -muclibc */
  OPT_munaligned_access = 1802,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1803,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1804,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1805,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1806,              /* -mword-relocations */
  OPT_n = 1807,                              /* -n */
