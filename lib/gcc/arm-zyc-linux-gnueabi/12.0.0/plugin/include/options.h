...
enum opt_code
{
  ...
  OPT_mbionic = 1765,                        /* -mbionic */
  OPT_mbranch_cost_ = 1766,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1767,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1768,     /* -mcaller-super-interworking */
  OPT_mcmse = 1769,                          /* -mcmse */
  OPT_mcpu_ = 1770,                          /* -mcpu= */
  OPT_mfdpic = 1771,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1772,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1773,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1774,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1775,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1776,                  /* -mfp16-format= */
  OPT_mfpu_ = 1777,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1778,             /* -mgeneral-regs-only */
  OPT_mglibc = 1779,                         /* -mglibc */
  /* OPT_mhard_float = 1780, */              /* -mhard-float */
  OPT_mlibarch_ = 1781,                      /* -mlibarch= */
  OPT_mlittle_endian = 1782,                 /* -mlittle-endian */
  OPT_mlong_calls = 1783,                    /* -mlong-calls */
  OPT_mmusl = 1784,                          /* -mmusl */
  OPT_mneon_for_64bits = 1785,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1786,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1787,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1788,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1789,               /* -mprint-tune-info */
  OPT_mpure_code = 1790,                     /* -mpure-code */
  OPT_mrestrict_it = 1791,                   /* -mrestrict-it */
  OPT_msched_prolog = 1792,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1793,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1794,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1795, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1796,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1797,                         /* -mthumb */
  OPT_mthumb_interwork = 1798,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1799,                  /* -mtls-dialect= */
  OPT_mtp_ = 1800,                           /* -mtp= */
  OPT_mtpcs_frame = 1801,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1802,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1803,                         /* -mtune= */
  OPT_muclibc = 1804,                        /* -muclibc */
  OPT_munaligned_access = 1805,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1806,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1807,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1808,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1809,              /* -mword-relocations */
  OPT_n = 1810,                              /* -n */
  ...
  OPT_time = 1935,                           /* -time */
  OPT_time_ = 1936,                          /* -time= */
  OPT_tno_android_cc = 1937,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1938,                 /* -tno-android-ld */
