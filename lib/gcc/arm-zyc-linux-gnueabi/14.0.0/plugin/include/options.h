...
enum opt_code
{
  ...
  OPT_profile = 1985,                        /* -profile */
  OPT_pthread = 1986,                        /* -pthread */
  OPT_quiet = 1987,                          /* -quiet */
  OPT_r = 1988,                              /* -r */
  OPT_rdynamic = 1989,                       /* -rdynamic */
  ...
  OPT_time = 2077,                           /* -time */
  OPT_time_ = 2078,                          /* -time= */
  OPT_tno_android_cc = 2079,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2080,                 /* -tno-android-ld */
