...
enum opt_code
{
  ...
  OPT_profile = 1984,                        /* -profile */
  OPT_pthread = 1985,                        /* -pthread */
  OPT_quiet = 1986,                          /* -quiet */
  OPT_r = 1987,                              /* -r */
  OPT_rdynamic = 1988,                       /* -rdynamic */
  OPT_remap = 1989,                          /* -remap */
  OPT_reverse_sort = 1990,                   /* -reverse-sort */
  OPT_s = 1991,                              /* -s */
  OPT_save_temps = 1992,                     /* -save-temps */
  OPT_save_temps_ = 1993,                    /* -save-temps= */
  OPT_shared = 1994,                         /* -shared */
  OPT_shared_libgcc = 1995,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1996,               /* -shared-libphobos */
  OPT_size_sort = 1997,                      /* -size-sort */
  /* OPT_specs = 1998, */                    /* -specs */
  OPT_specs_ = 1999,                         /* -specs= */
  OPT_static = 2000,                         /* -static */
  OPT_static_libasan = 2001,                 /* -static-libasan */
  OPT_static_libgcc = 2002,                  /* -static-libgcc */
  OPT_static_libgfortran = 2003,             /* -static-libgfortran */
  OPT_static_libgm2 = 2004,                  /* -static-libgm2 */
  ...
  OPT_static_libquadmath = 2011,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2012,               /* -static-libstdc++ */
  OPT_static_libtsan = 2013,                 /* -static-libtsan */
  OPT_static_libubsan = 2014,                /* -static-libubsan */
  OPT_static_pie = 2015,                     /* -static-pie */
  /* OPT_std_c__03 = 2016, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2017, */                /* -std=c++0x */
  OPT_std_c__11 = 2018,                      /* -std=c++11 */
  OPT_std_c__14 = 2019,                      /* -std=c++14 */
  OPT_std_c__17 = 2020,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2021, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2022, */                /* -std=c++1z */
  OPT_std_c__20 = 2023,                      /* -std=c++20 */
  OPT_std_c__23 = 2024,                      /* -std=c++23 */
  ...
  OPT_time = 2076,                           /* -time */
  OPT_time_ = 2077,                          /* -time= */
  OPT_tno_android_cc = 2078,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2079,                 /* -tno-android-ld */
